                ...
                <div class="row">
                  ...
                  <form class="col-md-6" action="auth.php" method="POST">
                    <div class="form-group row">
                      ...
                      <label for="inputEmail1" class="col-sm-3 col-form-label">Your Email</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputEmail1" value="<?= $_SESSION['email']; ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword2" class="col-sm-3 col-form-label">Current Password</label>
                      <div class="col-sm-8">
                        <input type="password" name="current_password" class="form-control" id="inputPassword2" placeholder="Password">
                      </div>
                    </div>
                    <div class="form-group row">
